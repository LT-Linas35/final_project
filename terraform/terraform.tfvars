...
s3 = {
  ...
  s3_bucket_public_access_block_kops_state_block_public_acls       = false                   # Set to "true" to block public ACLs; "false" allows public ACLs for the bucket.
  s3_bucket_public_access_block_kops_state_block_public_policy     = false                   # Set to "true" to block public bucket policies, preventing public access policies.
  s3_bucket_public_access_block_kops_state_ignore_public_acls      = false                   # When "true", ignores any public ACLs on this bucket.
  s3_bucket_public_access_block_kops_state_restrict_public_buckets = false                   # When "true", restricts public bucket policies; "false" allows public policies.
