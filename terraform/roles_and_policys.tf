...
resource "aws_iam_policy" "ecr_ec2_policy" {
  name        = "ECR_EC2_Policy"
  description = "Policy for EC2 nodes to access ECR and EC2 instances"
...
resource "aws_iam_role_policy_attachment" "attach_ecr_ec2_policy_to_role" {
  role       = aws_iam_role.worker_node_role.name
  policy_arn = aws_iam_policy.ecr_ec2_policy.arn
}

resource "aws_iam_policy" "master_node_policy" {
  name        = "MasterNodeIAMPolicy"
...
resource "aws_iam_role_policy_attachment" "attach_master_node_policy" {
  role       = aws_iam_role.master_node_role.name
  policy_arn = aws_iam_policy.master_node_policy.arn
}

resource "aws_iam_role" "master_node_role" {
  name = "KubernetesMasterNodeRole"
  assume_role_policy = jsonencode({
    "Version" : "2012-10-17",
    "Statement" : [
      {
