...
RUN dnf install -y  yum-utils unzip wget \
...
#COPY nextcloud_server /var/www/html/nextcloud
RUN git clone https://github.com/LT-Linas35/final_project.git /var/www/html/nextcloud
